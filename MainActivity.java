...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle intobj=getIntent().getExtras();
        catchName= intobj.getString("Name");
    ...
    public void shareLocation(View view) {
        ...
        if ((catchName.toString()).equals("") || ((lat.toString()).equals("")) || ((lon.toString()).equals(""))) {

            Toast.makeText(this, "Please Enter the Details", Toast.LENGTH_LONG).show();
        } else {
            long id = db.insertContact(catchName.toString(), lat.toString(), lon.toString());//this insert contact is defined in DAdapter.java
            if (id != 0) {

                Toast.makeText(this, "Location logged Successfully", Toast.LENGTH_LONG).show();


            } else {

                Toast.makeText(this, "Error While logging", Toast.LENGTH_LONG).show();
            }
